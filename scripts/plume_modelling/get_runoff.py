...
# Path to Mankoff et al. 2020 runoff dataset — set in config.yaml
p2r = _cfg['paths']['mankoff_runoff_dir']
...
def main():
    ...
    out_path = Path(__file__).parent.parent.parent / _cfg['output']['data_dir'] / 'runoff.nc'
    runoff_ds.to_netcdf(out_path)
